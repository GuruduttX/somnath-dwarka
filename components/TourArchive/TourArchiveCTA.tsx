...
import { ArrowRight, Phone, MapPin, Star, Sparkles } from "lucide-react";
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 items-center gap-7 lg:grid-cols-2 lg:gap-14">
            ...
            <div className="flex flex-col gap-4 text-center lg:text-left">
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="font-serif text-[clamp(22px,3.8vw,40px)] font-bold leading-[1.12] tracking-tight text-white"
              >
              ...
              >
                <button
                  ...
                  className="group inline-flex w-full items-center justify-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-orange-600 shadow-md shadow-black/12 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 sm:w-auto"
                >
                ...
                <Link
                  href="/tours"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/30 bg-white/10 px-6 py-3 text-sm font-medium text-white backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-white/18 active:translate-y-0 sm:w-auto"
                >
                  View All Packages
                </Link>
              </motion.div>
      ...
      <CommonEnquiryForm
        ...
        defaultService="Somnath Dwarka Tour"
      />
    </>
  );
}