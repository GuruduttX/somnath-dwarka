      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {trustItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="relative h-full bg-white rounded-2xl p-6 shadow-lg shadow-orange-100/50 border border-orange-100/50 hover:shadow-xl hover:shadow-orange-200/50 hover:-translate-y-2 transition-all duration-300 overflow-hidden">
                  {/* Top gradient accent */}
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-orange-500 via-orange-500 to-amber-500 rounded-2xl p-1">
            ...
            <button className="text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10 transition-colors w-full sm:w-auto">
              Book Your Yatra Now →
            </button>
          </div>
        </motion.div>
