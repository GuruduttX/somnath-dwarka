       ...
       <div className="relaive">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10 md:pb-16">
          ...
          */}
          ...
          {/* DESKTOP mosaic */}
          <div className="hidden lg:grid grid-cols-3 gap-3" style={{ gridTemplateRows: "240px 220px" }}>

            {/* Hero — spans 2 rows on left col */}
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                <div>
                  ...
                  <div className="flex flex-wrap items-baseline gap-x-2 mt-1">
                    <span className="text-lg sm:text-2xl font-bold text-white leading-tight">
                ...
                <button
                  ...
                  className="hidden md:block shrink-0 px-8 py-3.5 rounded-xl bg-white text-orange-600 font-bold shadow-lg hover:scale-105 hover:shadow-xl transition-all duration-300 cursor-pointer"
                >
                  Enquire Now →
                </button>
              </div>
