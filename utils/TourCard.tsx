      ...
      <div className="group overflow-hidden rounded-3xl bg-white shadow-md hover:shadow-xl transition-shadow duration-300 border border-gray-100">
        ...
        <div className="px-5 pb-5 pt-4">
          ...
          <div className="flex items-end justify-between">
            <div>
              <p className="text-[10.5px] font-semibold uppercase tracking-[0.1em] text-gray-400">
                Starting From
              </p>
              <p className="mt-0.5 text-[26px] font-bold leading-none text-gray-900">
                ₹{pkg.price.toLocaleString("en-IN")}
              </p>
              <p className="mt-1 text-[13px] font-medium text-gray-400 line-through">
                ₹{pkg.originalPrice.toLocaleString("en-IN")}
              </p>
            </div>

            <button className="rounded-2xl bg-orange-500 px-7 py-3 text-[14.5px] font-bold text-white shadow-md shadow-orange-200 transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-600 hover:shadow-lg hover:shadow-orange-200 active:translate-y-0">
              Book Now
            </button>
          </div>
        </div>
