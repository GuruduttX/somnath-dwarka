...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: "/somnath", destination: "/somnath-tour-package/", permanent: true },
      { source: "/somnath/:path*", destination: "/somnath-tour-package/:path*/", permanent: true },
      { source: "/dwarka", destination: "/dwarka-tour-package/", permanent: true },
      { source: "/dwarka/:path*", destination: "/dwarka-tour-package/:path*/", permanent: true },
