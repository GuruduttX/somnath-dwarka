 ...
 * displays them (home page reviews section, guide pages).
 *
 * IMPORTANT — read before adding an entry:
 *
 * This project does not publish invented customer feedback. The entries in
 * TESTIMONIALS were confirmed by the client (2026-09-24) as genuine reviews from
 * real guests, and the home page marks them up as Review / AggregateRating
 * JSON-LD. Each is shown at 4.9 per the client (2026-09-24); the card, the
 * Review markup and the aggregate all read this one value, so they always
 * agree. Only add a review a named guest actually gave: a fabricated review is a lie about a real person's experience,
 * and in schema form it is a manual-action risk.
 */
import type { RealReview } from "@/src/lib/seo";
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 4.9, initials: "RS", bg: "#FFF3EA", color: "#C2410C",
  ...
  },
  {
    ...
    rating: 4.9, initials: "PM", bg: "#FFFBEB", color: "#B45309",
  ...
  },
  {
    ...
    rating: 4.9, initials: "AP", bg: "#FFF0F3", color: "#9D174D",
  ...
  },
  {
    ...
    rating: 4.9, initials: "KN", bg: "#FFF3EA", color: "#C2410C",
  ...
  },
  {
    ...
    rating: 4.9, initials: "SI", bg: "#FFFBEB", color: "#B45309",
  ...
  },
  {
    ...
    rating: 4.9, initials: "MG", bg: "#FFF0F3", color: "#9D174D",
  ...
  },
  {
    ...
    rating: 4.9, initials: "DV", bg: "#FFF3EA", color: "#C2410C",
  ...
  },
  {
    ...
    rating: 4.9, initials: "AJ", bg: "#FFFBEB", color: "#B45309",
  ...
  },
  {
    ...
    rating: 4.9, initials: "VS", bg: "#FFF0F3", color: "#9D174D",
...
/** TESTIMONIALS in the shape the Review / AggregateRating schema builder takes. */
export const TESTIMONIAL_REVIEWS: RealReview[] = TESTIMONIALS.map((t) => ({
  author: t.name,
  rating: t.rating,
  body: t.review,
}));
