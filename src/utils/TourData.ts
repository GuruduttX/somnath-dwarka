...
export const TOUR_PACKAGES: TourPackage[] = [
  {
    id: 1,
    slug: "somnath-jyotirlinga-darshan",
  ...
  {
    id: 3,
    slug: "somnath-dwarka-grand-tour",
  ...
  {
    id: 6,
    slug: "gujarat-pilgrimage-circuit",
