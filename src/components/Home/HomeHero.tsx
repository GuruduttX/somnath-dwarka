        ...
        <div className="relative z-[2] flex flex-1 flex-col justify-center px-4 pt-24 sm:px-6 md:px-8 lg:flex-row lg:items-center lg:gap-16 lg:px-16 lg:pt-32">
          ...
          <div className="flex min-w-0 flex-1 flex-col items-center pb-4 text-center lg:items-start lg:pb-12 lg:text-left">
            ...
            <p className="anim d1 mb-3 text-[11px] font-normal uppercase tracking-[0.14em] text-[rgba(255,200,130,0.7)] sm:text-xs">
              ...
              <div className="relative mt-5 w-full max-w-[420px] overflow-hidden rounded-3xl border border-white/[0.14] shadow-[0_24px_60px_rgba(0,0,0,0.45)] sm:hidden [aspect-ratio:16/11]">
                <img
                  src={SOMNATH_DWARKA}
                  alt="Somnath Temple"
              ...
              >
                <defs>
                  <linearGradient id="cardStrokeSomnathMobile" x1="0" y1="0" x2="1" y2="1">
            ...
            {/* Headline */}
            <h1 className="font-playfair anim d2 mb-5 text-4xl font-black leading-[1.05] tracking-[-0.03em] text-orange-100 mt-4 sm:mt-0 sm:text-5xl md:text-6xl lg:text-7xl xl:text-[88px]">
              Somnath &amp;&nbsp;
            ...
            <div className="anim d4 mb-8 flex w-full flex-col gap-3 sm:flex-row sm:justify-center lg:justify-start">
              <button onClick={()=>setOpen(true)}  className="inline-flex w-full items-center justify-center cursor-pointer gap-[9px] rounded-[14px] bg-[linear-gradient(135deg,#FF6B1A_0%,#FF8C38_50%,#FFAB55_100%)] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_8px_30px_rgba(255,100,20,0.4),0_2px_8px_rgba(0,0,0,0.2)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_36px_rgba(255,100,20,0.5)] active:translate-y-0 sm:w-auto">
                <Star size={15} />
                Explore Packages
                <ArrowRight size={15} />
              </button>
              ...
              {STATS.map(({ value, suffix, label }, i) => (
                <React.Fragment key={label}>
                  <div className="shrink-0">
                    {/* font-playfair */}
                    <div className=" text-2xl font-bold leading-none text-[#FF9A45] sm:text-3xl">
                      <CountUp
                        end={value}
                        duration={600}
                        suffix={suffix}
                  ...
                  {i < STATS.length - 1 && (
                    <div className="h-9 w-px shrink-0 bg-white/[0.12]" />
                  )}
                </React.Fragment>
              ))}
            </div>
