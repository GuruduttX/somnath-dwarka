...
import { TOUR_PACKAGES } from "@/src/utils/TourData";
  ...
  return (
    <>
      ...
      <div className="mb-9 flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap gap-2.5">
          {FILTERS.map((f) => (
            <button
              ...
              className={`
                rounded-full px-5 py-2 text-[13.5px]  cursor-pointer font-medium transition-all duration-200
                ${activeFilter === f
        ...
        <div className="flex items-center cursor-pointer gap-2 text-[13px] text-gray-400">
      ...
      {hasMore && (
        <div className="mt-10 flex flex-col items-center gap-2">
          <button
            ...
            className="rounded-2xl bg-orange-500 px-10 py-3.5 text-[14.5px] font-bold text-white shadow-md shadow-orange-200 transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-600 hover:shadow-lg active:translate-y-0"
          >
            View More Packages
          </button>
      ...
      <div className="mt-12 flex flex-col items-center gap-3 text-center">
        ...
        <button onClick={() => setOpen(true)} className="cursor-pointer rounded-2xl border-2 border-orange-500 px-8 py-3 text-[14.5px] font-bold text-orange-500 transition-all duration-200 hover:bg-orange-500 hover:text-white hover:shadow-lg hover:shadow-orange-200 active:scale-95">
