...
const DestRoutes = ({
  ...
  return (
    <div className="border border-blue-900/50 rounded-2xl w-full p-6 bg-blue-950/20 shadow-[0_4px_20px_rgba(0,0,0,0.4)]">
      ...
      {/* Source */}
      <div className="mb-5">
        <label className="text-sm text-blue-300/70 font-medium">Source (Fixed)</label>
        <input
          type="text"
          required
      ...
      {/* Destination */}
      <div className="mb-6">
        <label className="text-sm text-blue-300/70 font-medium">Destination (Fixed)</label>
        <input
          type="text"
          required
      ...
      <div>
        ...
        <div className="space-y-3 mt-3">
          {route.segments.map((segment) => (
            <div
              key={segment.id}
              className="border border-blue-900/50 rounded-xl p-4 bg-blue-950/30"
            >
